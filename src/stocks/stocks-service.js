const StocksService = {
  ...
  // },
  insertStock(knex, ticker_symbol, recommendation_status, stock_value, posting, purchase_price) {
    return knex('stock_holdings').insert({ticker_symbol: ticker_symbol}, {recommendation_status: recommendation_status}, {stock_value: stock_value}, {posting: posting}, {purchase_price: purchase_price}).returning("*")
  },
  getById(knex, id) {
    return knex
